...
#' crs = "EPSG:27200")
#' bpi<- BPI_Old(r, radius = c(2,4), unit = "cell", na.rm = TRUE)
#' plot(bpi)
#' @import terra
...
BPI_Old<- function(r, radius=NULL, unit= "cell", w=NULL, na.rm=FALSE, include_scale=FALSE, filename=NULL, overwrite=FALSE, wopt=list()){
  og_class<- class(r)[1]
