...
<img src="`r fig_dir`kwindow.png" width="50%">
...
<img src="`r fig_dir`SlpAsp.png" width="70%">
...
<img src="`r fig_dir`Qfit_annotated.png" width="70%">
...
<img src="`r fig_dir`VRM_annotated.png" width="70%">

Figure adapted from Sappington et al. (2007)

<img src="`r fig_dir`VRM_focal.png" width="70%">
...
<img src="`r fig_dir`chaintape.png" width="90%">

Figure adapted from Friedman et al. (2012) and created with BioRender.com.


<img src="`r fig_dir`SAPA_annotated.png" width="70%">
...
<img src="`r fig_dir`adj_sd.png" width="80%">
...
<img src="`r fig_dir`RIE.png" width="80%">
...
<img src="`r fig_dir`WindowShapes.png" width="100%">
