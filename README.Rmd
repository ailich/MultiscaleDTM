...
Also, this package relies on the `terra` package for handling of raster data. To install the development version of `terra`, use `install.packages('terra', repos='https://rspatial.r-universe.dev')`.
